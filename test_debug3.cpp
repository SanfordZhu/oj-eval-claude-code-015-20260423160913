...
void insert(const string& key, int value) {
    ...
    cerr << "insert: key=" << key << ", value=" << value << ", bucket=" << bucket << ", entry_sz=" << entry_sz << endl;
    ...
    while (pos >= 0) {
        ...
        cerr << "  block at pos=" << pos << ", num_entries=" << num_entries << ", data_sz=" << data_sz << ", check: " << (data_sz + entry_sz + 8) << " <= " << BLOCK_SIZE << " = " << (data_sz + entry_sz + 8 <= BLOCK_SIZE) << endl;
